						...
						<div class="card bg-secondary shadow">
							...
							<div class="card-body">
								<form method="post" action="ajouterClient">
									<h6 class="heading-small text-muted mb-4">Informations du
										compte</h6>
									<div class="pl-lg-4">
										<div class="row">
											<div class="col-lg-6">
													...
													<div>
														<div class="form-check form-check-inline">
															<input class="form-check-input" type="radio"
																name="compte" id="inlineRadio1" value="courant">
															<label class="form-check-label" for="inlineRadio1">Courant</label>
														</div>
														<div class="form-check form-check-inline">
															<input class="form-check-input" type="radio"
																name="compte" id="inlineRadio2" value="epargne">
										...
										<div class="row">
											<div class="col-lg-6">
												<div class="form-group">
													<label class="form-control-label">Solde</label> <input
														type="text" class="form-control form-control-alternative"
														placeholder="250000 FCFA" name="solde">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group">
													<label class="form-control-label" for="input-first-name">Découvert/Taux</label>
													<input type="text"
														class="form-control form-control-alternative"
														placeholder="0.1/50000" name="tauxDecouvert">
												</div>
											</div>
										</div>
										<div class="row">
