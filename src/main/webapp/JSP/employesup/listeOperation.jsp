				...
				<div class="col">
					<div class="card shadow">
						<div class="card-header border-0">
							<h3 class="mb-0">La liste des opérations</h3>
						</div>
							...
							<table class="table align-items-center table-flush">
								<thead class="thead-light">
									<tr>
										...
										<th scope="col">Num opération</th>
										<th scope="col">Num compte</th>
										<th scope="col">Employé</th>
									</tr>
								</thead>
								<tbody>
									<c:forEach items="${listeOperation}" var="op">
										<tr>
											<td>
												<div class="media align-items-center">
													<div class="media-body">
														<span class="badge badge-dot"> <i class="bg-info"></i>${op}</span>
													</div>
												</div>
											</td>
											<td><span class="badge badge-dot mr-4"><i
													class="bg-warning"></i>${op.dateOperation}</span></td>
											<td><span class="badge badge-dot mr-4"><i
													class="bg-warning"></i>${op.montant}</span></td>
											<td><span class="badge badge-dot mr-4"><i
													class="bg-warning"></i>${op.numOperation} </span></td>
											<td>
												<div class="d-flex align-items-center">
													<span class="badge badge-dot"> <i class="bg-success"></i>${op.compte.numCompte}</span>
												</div>
											</td>
											<td>
												<div class="d-flex align-items-center">
													<span class="badge badge-dot"> <i class="bg-success"></i>${op.employe.prenom} ${op.employe.nom}</span>
												</div>
											</td>
											<td class="text-right">
												<div class="dropdown">
