	...
	<nav
		...
		<div class="container-fluid">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link"
					href="listeEmploye"> <i class="fas fa-users text-yellow"></i>
						Employés
				</a></li>
				<li class="nav-item"><a class="nav-link"
					href="listeClient"> <i class="fas fa-users text-primary"></i>
						Clients
				</a></li>
				<li class="nav-item"><a class="nav-link"
					href="listeOperation"> <i
				...
				<div class="col">
					<div class="card shadow">
						<div class="card-header border-0">
							<h3 class="mb-0">La liste des employés</h3>
						</div>
							...
							<table class="table align-items-center table-flush">
								<thead class="thead-light">
									<tr>
										...
										<th scope="col">Chef hiérarchique</th>
										<th scope="col">Add to groupe</th>
											...
											<td>
												<div class="media align-items-center">
													<div class="media-body">
														<span class="badge badge-dot"> <i class="bg-info"></i>${emp.cuser.login}</span>
													</div>
												</div>
											</td>
											<td><span class="badge badge-dot mr-4"><i
													class="bg-warning"></i>${emp.matriculeEmp}</span></td>
											<td><span class="badge badge-dot mr-4"><i
													class="bg-warning"></i>${emp.nom}</span></td>
											<td><span class="badge badge-dot mr-4"><i
													class="bg-warning"></i>${emp.prenom} </span></td>
											<td>
												<div class="d-flex align-items-center">
													<span class="badge badge-dot"> <i class="bg-success"></i>${emp.supHierarchique.nom}</span>
												</div>
											</td>
											<td class="text-right">
												<div class="dropdown">
													...
													<div
														...
														<c:forEach items="${listeGroupe}" var="grp">
															<a class="dropdown-item" href="employeToGroupe?idEmp=${emp.idEmploye}&idGrp=${grp.numGroupe}">${grp.nomGroupe}</a>
														</c:forEach>
													</div>
												</div>
											</td>
