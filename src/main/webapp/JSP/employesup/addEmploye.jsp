						...
						<div class="card bg-secondary shadow">
							<div class="card-header bg-white border-0">
								<div class="row align-items-center">
									<div class="col-8">
										<h3 class="mb-0">Infos de l'employé</h3>
									</div>
								</div>
							</div>
							<div class="card-body">
										...
										<div class="row">
											<div class="col-lg-6">
												<div class="form-group">
													<label class="form-control-label">Employe sup</label> <select
														required="required" class="form-control" name="idEmpSup">
														<c:forEach items="${listeEmpSup}" var="liste">
															<c:if test="${liste.supHierarchique.idEmploye==null}">
																<option value="${liste.idEmploye}">
																	<c:out value="${liste.prenom} ${liste.nom}"></c:out>
																</option>
															</c:if>
														</c:forEach>
													</select>
											...
											<div class="col-lg-6">
												<div class="form-group">
													<label class="form-control-label">Matricule</label> <input
														type="text" class="form-control form-control-alternative"
														placeholder="KANE001" name="matricule" required="required">
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-lg-6">
												<div class="form-group">
													<label class="form-control-label" for="input-last-name">Login</label>
													<input type="text"
														class="form-control form-control-alternative"
														placeholder="KANE" name="login">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group">
													...
													<input type="text"
														class="form-control form-control-alternative"
														placeholder="Marie" name="password">
												</div>
											</div>
										</div>
										<div class="row">
